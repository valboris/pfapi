...
class UserInfoApi extends ApiClient {
	...
	*/
	public function SaveUser($user = false, $profile = false)
	{
		return $this->CallApi('UserInfo/SaveUser',array('user' => $user, 'profile' => $profile),false);
	}
	...
	*/
	public function ReactivateCredit()
	{
		return $this->CallApi('UserInfo/ReactivateCredit',array(),false);
	}
